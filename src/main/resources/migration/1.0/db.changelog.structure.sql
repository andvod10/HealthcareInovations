...
CREATE TABLE IF NOT EXISTS "public"."department" ("id" VARCHAR(255) NOT NULL, "created_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "name" VARCHAR(255), "created_by" VARCHAR(255), "updated_by" VARCHAR(255), "manager_id" VARCHAR(255), CONSTRAINT "department_pkey" PRIMARY KEY ("id"));

-- changeset avodv:1668097141214-2
CREATE TABLE IF NOT EXISTS "public"."employees" ("id" VARCHAR(255) NOT NULL, "created_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "email" VARCHAR(255), "full_name" VARCHAR(255), "password" VARCHAR(255), "created_by" VARCHAR(255), "updated_by" VARCHAR(255), "dep_id" VARCHAR(255), CONSTRAINT "employees_pkey" PRIMARY KEY ("id"));

-- changeset avodv:1668097141214-3
ALTER TABLE "public"."department" DROP CONSTRAINT IF EXISTS "fk4ibsp65tk9ue7amjgqe2oxmdn";
...
ALTER TABLE "public"."employees" DROP CONSTRAINT IF EXISTS "fk4xxve990vv5nd2qbdj4i6m21h";
...
ALTER TABLE "public"."department" DROP CONSTRAINT IF EXISTS "fkd25eiwpa8towqc18sr7hbsnn";
...
ALTER TABLE "public"."department" DROP CONSTRAINT IF EXISTS "fke256xyrpq2i7id8gpdgpc8cbf";
...
ALTER TABLE "public"."employees" DROP CONSTRAINT IF EXISTS "fkialhyfka8wy8ljopxkstd1xcr";
...
ALTER TABLE "public"."employees" DROP CONSTRAINT IF EXISTS "fkolojvdrleop0de8xe9vpoplyv";
