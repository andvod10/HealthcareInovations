...
CREATE TABLE IF NOT EXISTS "public"."token" ("id" VARCHAR(255) NOT NULL, "created_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "access_token" VARCHAR(1024), "refresh_token" VARCHAR(1024), "created_by" VARCHAR(255), "updated_by" VARCHAR(255), "employee_id" VARCHAR(255), CONSTRAINT "token_pkey" PRIMARY KEY ("id"));

-- changeset avodv:1668537185950-2
ALTER TABLE "public"."employees" ADD IF NOT EXISTS "account_role" INTEGER;

-- changeset avodv:1668537185950-3
ALTER TABLE "public"."employees" ADD IF NOT EXISTS "is_active" BOOLEAN;

-- changeset avodv:1668537185950-4
ALTER TABLE "public"."token" DROP CONSTRAINT IF EXISTS "fkm7vx4l4mwg56vn65s0mg9lskg";
...
ALTER TABLE "public"."token" DROP CONSTRAINT IF EXISTS "fkpl3buw6o3i8aofm0os26gsi3c";
...
ALTER TABLE "public"."token" DROP CONSTRAINT IF EXISTS "fkryipflmv40b6pndxmsl7mi717";
